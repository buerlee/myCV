...
I have over 3 years' experience in building enterprise and web based application. I am hard working, reliable and keen to work in a forward thinking team. I am creative, independent and a good communicator with a desire to acquire new skills as well as advance existing skills.
...
\textsc{Jan 2016-Current} & Software Engineer at \textsc{iPayroll ltd}, Wellington \\
& \emph{A Full Service Payroll System}\\ 
& \footnotesize{
Developed customized financial report regarding of specific requirement.

Developed a automated API documentation system using Swagger-UI, Springfox.

Developed new features and maintained system and API by Java, postgresSQL, Spring framework.

Developed Time and Attendance front end system with AngularJs.
}\\
\multicolumn{2}{c}{} \\
...
& \footnotesize{
Developed new Java crawler for IBM LotusNotes, and used commercially.

Optimised the Java crawler for IBM LotusNotes to double the performance.
...
%\textsc{Mar 2015-July 2015} & FreeLancer Android Developer at \textsc{Yimin}, Wellington \\
%& \emph{A Immigration Helper Application}\\ 
%& \footnotesize{
%Using Android Studio, Butter knife and Dagger for application developement.
%}\\
%\multicolumn{2}{c}{} \\
